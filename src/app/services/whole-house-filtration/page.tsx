...
export const metadata: Metadata = {
  ...
  description:
    "Clean, filtered water from every faucet in your home. Aqua Otter installs whole house filtration systems for city and well water across Southern Michigan.",
};
