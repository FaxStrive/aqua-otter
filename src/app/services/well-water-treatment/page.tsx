...
export const metadata: Metadata = {
  ...
  description:
    "Expert well water treatment in Southern Indiana. We eliminate iron, sulfur, bacteria, manganese, and more with custom filtration systems built for your well.",
};
