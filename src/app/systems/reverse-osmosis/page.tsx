...
export default function ReverseOsmosisPage() {
  ...
  return (
    <>
      ...
      >
        <video autoPlay loop muted playsInline poster="/videos/system-ro-poster.jpg" className="absolute inset-0 w-full h-full object-cover pointer-events-none" style={{ opacity: 0.28 }}>
          <source src="/videos/system-ro.mp4" type="video/mp4" />
        </video>
