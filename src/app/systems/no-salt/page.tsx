...
export default function NoSaltPage() {
  ...
  return (
    <>
      ...
      >
        <video autoPlay loop muted playsInline poster="/videos/system-nosalt-poster.jpg" className="absolute inset-0 w-full h-full object-cover pointer-events-none" style={{ opacity: 0.28 }}>
          <source src="/videos/system-nosalt.mp4" type="video/mp4" />
        </video>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:+13179616925" className="inline-flex items-center gap-2 px-7 py-4 rounded-full border text-sm font-medium" style={{ borderColor: "rgba(255,255,255,0.12)", color: "rgba(255,255,255,0.55)" }}>
                  (317) 961-6925
                </a>
              </div>
            </motion.div>
