          ...
          <div className="flex flex-col gap-5 lg:hidden">
            {products.map((p) => (
              <div
                ...
                style={{
                  borderColor: "rgba(18,189,251,0.12)",
                  boxShadow: "0 4px 24px rgba(12,31,46,0.07)",
                }}
              >
                <div
                  className="relative flex items-center justify-center"
                  style={{ backgroundColor: "#EAF6FE", height: 200 }}
                >
                  <div
                  ...
                  <Image
                    ...
                    style={{
                      maxHeight: 160,
                      filter: "drop-shadow(0 8px 20px rgba(18,189,251,0.2))",
                    }}
                  />
                </div>
                <div className="p-7">
                  <h3
                    className="font-display font-bold mb-2"
                    style={{ fontSize: "1.2rem", color: "#0C1F2E", letterSpacing: "-0.02em" }}
                  >
                    {p.name}
                  </h3>
                    ...
                    {p.specs.map(([label, value], i) => (
                      <div
                        ...
                        style={{
                          backgroundColor: i % 2 === 0 ? "#F8FBFF" : "#ffffff",
                          borderBottom:
                            i < p.specs.length - 1 ? "1px solid rgba(12,31,46,0.06)" : "none",
                        }}
                      >
