...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Google Tag Manager — HomePros Site-ID GTM-5WH7DWHM (top of <head>) */}
      ...
      >
        ...
        <noscript
          dangerouslySetInnerHTML={{
            __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5WH7DWHM" height="0" width="0" style="display:none;visibility:hidden"></iframe>`,
          }}
        />
