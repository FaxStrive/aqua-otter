...
const articleSchema = {
  ...
  "@type": "Article",
  headline: "Hard Water in Indiana: What Every Homeowner Needs to Know",
  ...
  mainEntityOfPage: "https://www.myaquaotter.com/blog/hard-water-indiana",
};
  ...
  return (
    <article className="pt-40 pb-24" style={{ backgroundColor: "#ffffff" }}>
      ...
      <div className="container-site max-w-2xl mx-auto">
        ...
        <p className="text-sm mb-10" style={{ color: "rgba(12,31,46,0.4)" }}>April 12, 2026 &nbsp;·&nbsp; 6 min read &nbsp;·&nbsp; By Larry Foster</p>
